...
<head>
    ...
    <!--[if lt IE 10]>
      ...
      <meta name="description" content="java project" />
      <meta name="author" content="Renan Machado Denardi" />
      <!-- Favicon icon -->
    ...
    <link rel="stylesheet" href="<%= request.getContextPath( ) %>/assets/pages/waves/css/waves.min.css" type="text/css" media="all">
      ...
      <!-- waves.css -->
      <link rel="stylesheet" href="<%= request.getContextPath( ) %>/assets/assets//assets/pages/waves/css/waves.min.css" type="text/css" media="all">
      <!-- themify icon -->
